...
rst_epilog = """
.. |apiservice| replace:: Rackspace Cloud Keep API
.. |no changes| replace:: None for this release.
.. |contract version| replace:: 1.0
.. |product name| replace:: Rackspace Cloud Keep
"""
...
html_title = 'Rackspace Cloud Keep Version 1.0 API Developer Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Keep'
...
latex_documents = [
  ('index', 'RackspaceCloudApiCloudKeepDeveloperDoc.tex', 'Rackspace Cloud Keep API Developer Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCloudApiCloudKeepDeveloperDoc', 'Rackspace Cloud Keep API Developer Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCloudApiCloudKeepDeveloperDoc', 'Rackspace Cloud Keep API Developer Guide',
   'Rackspace', 'RackspaceCloudApiCloudKeepDeveloperDoc', 'Learn about using the REST API for the Rackspace Cloud Keep service.',
   'Miscellaneous'),
]
